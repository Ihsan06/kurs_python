...
if __name__ == '__main__':
    ...
    print("\n------ Device as Tuples  ----------------")
    device = ("sbx-n9kv-ao", "cisco", "Nexus9000 C9300 Chassis", "nxos", "10.0.1.1")
    ...
    print("\n------ Device as Named Tuples  ----------------")
    Device = namedtuple('Device', ['name', 'vendor', 'model', 'os', 'ip'])
    device = Device("sbx-n9kv-ao", "cisco", "Nexus9000 C9300 Chassis", "nxos", "10.0.1.1")
    ...
    for device in devices:
        ...
        # **device: kwargs keyword argument: take dic and converts into list of device
