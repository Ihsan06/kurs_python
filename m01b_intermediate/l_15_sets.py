...
def print_ips():
    ...
    print("    --------------   ----------")
    for available_ip, used_ip in zip(available_ips_list, used_ips_list):  # ZIP iterate two things same time
        print(f"   {available_ip:>16}   {used_ip:<16}")


for index in range(180, 200, 3):  # ,3 skip count
