...
def create_device(device_index, subnet_index, random_ip=False):
    ...
    if device["vendor"] == "cisco":
        ...
        if device["os"] == "ios":
            device["version"] = choice(["15", "15E", "15SY", "12.25E"])
        ...
        device["os"] = "junos"
        device["version"] = choice(["12.3R12-S15", "15.187-S6", "18.4Rs-S3", "15.2XS3-0"])
...
def create_network(num_devices=1, num_subnets=1):
    ...
    for device in devices:
        ...
        # but for simplicity we are just going to replace the last byte with "g"
